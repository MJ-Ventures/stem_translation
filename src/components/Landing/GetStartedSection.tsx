...
const GetStartedSection = ({ onStartConversation }: GetStartedSectionProps) => {
  return (
    <div className="min-h-screen py-[100px] lg:py-[200px] px-5 lg:px-[100px] w-full bg-white flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-center">
        <div className="flex-1 flex flex-col">
            ...
            <GradientButton type="button" onClick={onStartConversation} className="mt-12 w-fit">Start Conversation</GradientButton>
        </div>
